<x-misc.modal title="Tambah Pembayaran" show="modalOpen" close-handler="modalOpen = false" :width="560">
    <div class="form-body">
        <div class="card" style="padding:12px 14px; margin-bottom:14px; background:var(--bg-3);">
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px 20px; font-size:12.5px;">
                ...
                <div><span style="color:var(--ink-3);">Customer</span><br><strong>{{ $invoice->customer->name }}</strong>
                </div>
