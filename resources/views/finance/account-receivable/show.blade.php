...
@section('content')
    ...
    <div x-data="paymentModule()" x-init="init()" class="order-page">
        <div class="order-hd order-hd--start">
            <div>
                <a href="{{ route('finances.account_receivables.index') }}" class="btn btn-ghost btn-sm"
        ...
        {{-- Add Payment modal --}}
        @include('finance.account-receivable.partials.payment-modal')
    </div>
@endsection
        ...
        function paymentModule() {
            return {
                ...
                async fetchData() {
                    ...
                    try {
                        const response = await axios.get(route('finances.account_receivables.payment_datatable'), {
                            params: {
