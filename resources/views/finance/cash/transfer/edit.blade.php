            ...
            return {
                ...
                async submit(status) {
                    ...
                    if (isValid) {
                        ...
                        try {
                            const response = await axios.put(route('finances.cash.transfer.update', {
                                    id: this.account.id,
                ...
                async init() {
                    ...
                    this.selectedAccount = this.accounts.find(acc => acc.id === this.formData.to_account_id) || null;
                    Swal.close();
                },
            };
        }
    </script>
    <div x-data="transferModule()" x-init="init()" class="order-page">
