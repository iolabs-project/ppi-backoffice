...
<div x-data="{ filter: 'semua' }" class="order-page">
  ...
  <div class="order-hd">
    ...
    <div class="order-actions">
      ...
      <a href="{{ route('penjualan.create') }}" class="btn btn-primary"><x-misc.icon name="plus" :size="15" />Tambah SO</a>
    </div>
  </div>
      ...
      <tbody>
        @foreach($salesOrders as $s)
          <tr class="row-tap"
            ...
            <td x-on:click.stop>
              <button class="btn btn-ghost btn-icon btn-sm" style="border:none;"><x-misc.icon name="more" :size="15" /></button>
            </td>
          </tr>
        @endforeach
      </tbody>
