  ...
  <div class="order-hd order-hd--start">
    <div>
      <a href="{{ route('penjualan.index') }}" class="btn btn-ghost btn-sm" style="margin-bottom:10px;">
        <x-misc.icon name="chev-left" :size="13" />Kembali ke Daftar SO
      </a>
    ...
    <div class="order-actions">
      ...
      <a href="{{ route('penjualan.pengiriman', $so['id']) }}" class="btn btn-dark">
        <x-misc.icon name="truck" :size="14" />Buat Pengiriman
      </a>
      <button class="btn btn-primary"><x-misc.icon name="receipt" :size="14" />Buat Tagihan</button>
    </div>
  </div>
