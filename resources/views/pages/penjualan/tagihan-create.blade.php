      ...
      <x-misc.field label="Pelanggan" :required="true">
        <div class="dropdown-wrap" @click.outside="customerOpen=false">
          <div class="input dropdown-trigger" @click="customerOpen=!customerOpen">
            ...
            <span style="flex:1; font-weight:500;" x-text="customer ? customer.nama : 'Pilih kontak'"></span>
                ...
                <div style="flex:1;" class="dropdown-wrap" @click.outside="it.produkOpen=false">
                  ...
                  <div class="dropdown-menu" x-show="it.produkOpen" x-cloak style="min-width:300px;">
                    <template x-for="p in produkList" :key="p.kode">
                      <div class="dropdown-item"
                        @click="it.nama=p.nama; it.kode=p.kode; it.satuan=p.satuan; it.harga=p.hargaJual; it.produkOpen=false">
