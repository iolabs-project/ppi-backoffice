...
@section('content')
    ...
    <div x-data="datatable()" x-init="fetchData()" class="order-page">
        <div class="order-hd">
            <div>
                <h1 class="order-title display">Pemesanan Penjualan</h1>
        ...
        <div class="table-toolbar">
            <div class="table-search">
                ...
                <input class="table-search__input" placeholder="Cari nomor SO / customer..."
    ...
    <script>
        function datatable() {
            return {
                ...
                async handleOpen(id) {
                    Swal.fire({
                        title: 'Apakah Anda yakin ingin membuka SO ini?',
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            ...
                            try {
                                ...
                                Swal.close();
                                let message = 'Terjadi kesalahan saat membuka SO. Silakan coba lagi.';
