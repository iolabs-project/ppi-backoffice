<x-misc.modal title="Form Kontak" show="modal === 'add_contact' || modal === 'edit_contact'" close-handler="modal = null">
            <div class="form-body">
                ...
                <div class="form-grid-2">
                    <x-misc.field label="Email">
                        <input class="input" type="email" x-model="form.email"
            ...
            <x-slot:footer>
                ...
                <button class="btn btn-primary" x-on:click="modal === 'add_contact' ? handleCreate() : handleUpdate()"><x-misc.icon name="check"
